...
original_image = cv2.imread("photo_2024-10-11_10-04-04.jpg")
...
model_inference_command = "./yolov5n_example ./cpu_model/hhb.bm image_preprocessed.bin"
...
cv2.imwrite("photo_result_CPU.jpg", image)
